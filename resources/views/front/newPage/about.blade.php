                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                <div class="about-choose-img">
                                    <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/service-9.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95 about-negative-mrg">
                                <div class="about-choose-img">
                                    <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/service-10.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                <div class="about-choose-img">
                                    <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/service-11.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95 about-negative-mrg">
                                <div class="about-choose-img">
                                    <img src="https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/service-12.png" alt="">
                                </div>
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/teacher/teacher-1.jpg" alt="">
                    </div>
                        ...
                        <div class="teacher-content">
                            ...
                            <div class="teacher-social">
                                <ul>
                                    ...
                                    <li><a class="youtube-play" href="#"><i class="fa-brands fa-youtube"></i></a></li>
                                    <li><a class="twitter" href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                    <li><a class="google-plus" href="#"><i class="fa-brands fa-google-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="fun-fact-area bg-img pt-130 pb-100" style="background-image:url('	https://htmldemo.net/glaxdu/glaxdu/assets/img/bg/bg-6.jpg');">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-one count-white">
                    <div class="count-img">
                        <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/funfact-1.png" alt="">
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-two count-white">
                    <div class="count-img">
                        <img src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/funfact-2.png" alt="">
                    </div>
                    <div class="count-content">
            ...
            <div class="testimonial-text-slider">
                <div class="testi-content-wrap">
                    <div class="testi-big-img">
                        <img alt="" src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/testimonial/testi-b1.jpg">
                    </div>
                   <div class="row no-gutters">
                       <div class="ml-auto col-lg-6 col-md-6">
                           <div class="testi-content bg-img default-overlay" style="background-image:url('	https://htmldemo.net/glaxdu/glaxdu/assets/img/bg/testi.png');">
                               ...
                               <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit, sed do eiusm od tempor incidi dunt ut labore et dolore magna aliqua. Ut enim  fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit </p>
                                ...
                                <div class="testi-arrow">
                                    <img alt="" src="https://htmldemo.net/glaxdu/glaxdu/assets/img/icon-img/testi-icon.png">
                                </div>
                           </div>
                       </div>
                   </div>
                ...
                <div class="testi-content-wrap">
                   <div class="testi-big-img">
                        <img alt="" src="https://htmldemo.net/glaxdu/glaxdu/assets/img/testimonial/testi-s3.jpg">
                    </div>
                   <div class="row no-gutters">
                        <div class="ml-auto col-lg-6 col-md-6">
